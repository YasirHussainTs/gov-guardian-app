package com.govguardian.app.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.govguardian.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.govguardian.app.security.DomainUserDetailsService", "createSpringSecurityUser");
