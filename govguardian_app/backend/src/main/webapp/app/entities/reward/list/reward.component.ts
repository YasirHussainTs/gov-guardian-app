...
import { EntityArrayResponseType, RewardService } from '../service/reward.service';
...
export class RewardComponent implements OnInit {
  ...
  trackId = (_index: number, item: IReward): number => this.rewardService.getRewardIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IReward[] | null): IReward[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.rewardService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
